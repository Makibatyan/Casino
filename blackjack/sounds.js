...
const Sound = {
  ...
  playBlackjack() {
    ...
    setTimeout(() => this.playVoiceReverb("voiceBlackjack", 1.0), 280);
  },
  ...
  playBust() {
    ...
    setTimeout(() => this.playVoiceReverb("voiceBust", 1.0), 200);
  },

  playOutcomeWin(tier) {
    this.playWin(tier);
    setTimeout(() => this.playVoiceReverb("voiceWin", 1.0), 120);
  },

  playOutcomeLose() {
    this.cardPlace(0);
    void this.playFile("coinLow", 0.32);
    setTimeout(() => this.playVoiceReverb("voiceLose", 1.0), 160);
  },

  playOutcomeEven() {
    this.cardPlace(0);
    setTimeout(() => this.playVoiceReverb("voiceEven", 1.0), 100);
  },
  ...
  play(name, opts = {}) {
    ...
    switch (name) {
      ...
      case "lose":
        ...
        break;
      case "voiceWin":
        this.playVoiceReverb("voiceWin", opts.volume ?? 1.0, opts.delayMs ?? 0);
        break;
      case "voiceLose":
        this.playVoiceReverb("voiceLose", opts.volume ?? 1.0, opts.delayMs ?? 0);
        break;
      case "voiceEven":
        this.playVoiceReverb("voiceEven", opts.volume ?? 1.0, opts.delayMs ?? 0);
        break;
      default:
        break;
    }
